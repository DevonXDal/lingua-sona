...
- When **Zon** merges with a classifier (`Zonza`, `Zonze`, etc.) → it names *the concept of that classifier*.  
  ...
  - `Zonze` = “Place.”  
- When **Zou** precedes a term → signals that a *significant or proper noun* follows.  
  - `Zou Zaw` → “(proper name) Zaw.”  
...
|  **Zai**   | Proper Noun / Significant Entity                                | `ZonZai` = Proper Name       | `Zai Devon` → Devon (proper)                  |
|  **Zou**   | Proper Name w/ Heavy Respect / Significance embedded elsewhere. | `ZonZou` = Significant       | `Zou Zaw` → Like Sir Zaw or Zaw, Your Majesty |
...
|  **Zooo**  | Concept / Mood / Idea                                           | `ZonZooo` = Concept          | `Zooo peace` → peaceful notion                |
|  **Zaw**   | Temporal / Time                                                 | `ZonZaw` = Time              | `Zaw morning` → at morning                    |
|  **Zoi**   | Group / Collective                                              | `ZonZoi` = Collective        | `Zoi meli` → group of women                   |
...
|  | `Ze Mail` | Post office |
|  | `Zaw Mail` | Mail time |
|  | `Zooo Mail` | The idea or system of mail |
...
- The `Zou` prefix provides **capitalization replacement**, marking significance or properness in nouns.  
